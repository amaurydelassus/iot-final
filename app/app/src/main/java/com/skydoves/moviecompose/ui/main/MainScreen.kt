        ...
        HomeTabScreen(
          ...
          selectItem = { tab, index ->
            when (tab) {
              ...
              MainScreenHomeTab.SALLE -> navController.navigate("${NavScreen.TvDetails.route}/$index")
...
enum class MainScreenHomeTab(
  ...
  SALLE(R.string.salle, Icons.Filled.Home),
  MOVIE(R.string.menu_movie, Icons.Filled.Tv),
